                ...
                <table className="w-full">
                    <thead className="bg-slate-900 text-white">
                        <tr className="text-sm font-black uppercase tracking-wider text-left">
                            <th className="px-10 py-6 text-slate-200">구매자 성함</th>
                            <th className="px-10 py-6 text-slate-200">제품 / 시리얼</th>
                            <th className="px-10 py-6 text-slate-200">만료일자</th>
                            <th className="px-10 py-6 text-slate-200">상태</th>
                            <th className="px-10 py-6 text-right text-slate-200">제어</th>
                        </tr>
                    </thead>
                        ...
                        {loading ? (
                            ...
                            return (
                                <tr key={lic.id} className="hover:bg-slate-50/50 transition-colors">
                                    <td className="px-10 py-2 font-black text-slate-800">{lic.buyer_name}</td>
                                    ...
                                    <td className="px-10 py-2 text-sm font-bold text-slate-500">
