            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-2xl z-50 overflow-hidden rounded-3xl bg-white shadow-2xl border border-slate-200/80 flex flex-col max-h-[88vh]"
                    >
                        {/* Integrated Header (No extra top spacing!) */}
                        <div className="px-6 pt-6 pb-4 border-b border-slate-100 bg-slate-50/90 relative">
                            <div className="flex items-start justify-between">
                                ...
                                <button 
                                    onClick={onClose}
                                    className="p-2 -mr-2 -mt-2 rounded-full text-slate-400 hover:text-slate-700 hover:bg-slate-200/60 transition-colors cursor-pointer"
                                    aria-label="닫기"
                                >
                                    <X className="w-5 h-5" />
                                </button>
                        ...
                        {/* Content Area */}
                        <div className="flex-1 overflow-y-auto px-6 py-6 md:px-8 space-y-6 text-sm text-slate-700 leading-relaxed scrollbar-thin scrollbar-thumb-slate-200">
                            {activeTab === 'privacy' && (
                                <div className="space-y-6">
                                    <section className="space-y-2">
                                        ...
                                        <ul className="list-disc pl-5 space-y-1.5 text-slate-600">
                                            ...
                                            <li><strong>결제 정보</strong>: 유료 라이선스 결제 승인 및 세금계산서/현금영수증 발행 (NHN KCP 암호화 처리)</li>
                            ...
                            {activeTab === 'terms' && (
                                <div className="space-y-6">
                                    ...
                                    <section className="space-y-2">
                                        ...
                                        <p className="text-slate-600">
                                            회사는 서비스 내에서 사용 가능한 디지털 소프트웨어 라이선스 키 또는 기간 이용권을 유료로 제공합니다.
                                        </p>
                                        <ul className="list-disc pl-5 space-y-1.5 text-slate-600">
                                            <li><strong>결제 수단</strong>: 신용카드, 계좌이체 등 회사가 제공하는 결제 수단 (NHN KCP 전자결제)</li>
                                            <li><strong>상품 형태</strong>: 결제 완료 즉시 발급·부여되는 무형의 디지털 소프트웨어 라이선스 키 (실물 배송 없음)</li>
                                        </ul>
                                    </section>
                                    ...
                                    <section className="space-y-2">
                                        ...
                                        <p className="text-slate-600">
                                            회사는 이용자가 타인의 권리를 침해하거나 서비스의 정상적인 운영을 방해하는 경우(비정상적인 대량 트래픽 유발, 라이선스 키 무단 공유/양도, 리버스 엔지니어링 등) 사전 통보 없이 서비스 이용을 제한하거나 라이선스 키를 회수할 수 있습니다.
                                        </p>
                                    </section>
                        ...
                        <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/90 flex items-center justify-between">
                            ...
                            <Button 
                                onClick={onClose} 
                                className="px-6 py-2 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold rounded-xl shadow-md transition-all active:scale-95 cursor-pointer"
                            >
                                확인
                            </Button>
                        </div>
