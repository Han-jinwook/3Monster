        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-100/80 via-slate-200/90 to-purple-100/70 flex flex-col font-sans">
            ...
            <footer className="bg-slate-950 text-slate-400 py-14 px-6 border-t border-slate-800">
                <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    {/* Bottom Row: Official Business Details */}
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 text-[11px] leading-relaxed text-slate-400">
                        <div className="space-y-1.5 max-w-3xl font-medium">
                            <p className="flex flex-wrap items-center gap-x-2.5 gap-y-1">
                                <span>상호명: <strong className="text-slate-200 font-bold">썬드림 주식회사</strong></span>
                                <span className="text-slate-700">|</span>
                                <span>대표자: <strong className="text-slate-200 font-bold">백은숙</strong></span>
                                <span className="text-slate-700">|</span>
                                <span>사업자등록번호: <strong className="text-slate-200 font-bold">333-87-00482</strong></span>
                                <span className="text-slate-700">|</span>
                                <span>통신판매업신고: <strong className="text-slate-200 font-bold">제 2023-인천부평-0929호</strong></span>
                            </p>
                            <p>
                                <span>사업장 주소: 21330 인천광역시 부평구 주부토로 236 인천테크노밸리 U1센터 C동 1110호/1111호</span>
                            </p>
                            <p className="flex flex-wrap items-center gap-x-2.5 gap-y-1">
                                <span>고객센터: <a href="tel:07074242695" className="text-slate-200 font-bold hover:underline">070-7424-2695</a> (평일 09:00~18:00)</span>
                                <span className="text-slate-700">|</span>
                                <span>이메일: <a href="mailto:chiu3@naver.com" className="text-slate-200 font-bold hover:underline">chiu3@naver.com</a></span>
                                <span className="text-slate-700">|</span>
                        ...
                        <div className="text-left lg:text-right shrink-0">
                            <p className="text-xs text-slate-400 font-bold">
                                © 2026 <strong className="text-slate-300">썬드림 주식회사 (SunDream Co., Ltd.)</strong>
                            </p>
                            <p className="text-[10px] text-slate-400 mt-0.5">All Rights Reserved. Powered by 3Monster Core.</p>
                        </div>
                    </div>
                </div>
            </footer>
