...
url = "https://suwinftalfgybvrnzruz.supabase.co/rest/v1/licenses?contact=eq.sundream7878@gmail.com"
headers = {
...
try:
    with urllib.request.urlopen(req) as response:
        ...
        for l in data:
            print(f"ID: {l['id']}, Contact: {l['contact']}, Serial: {l['serial_key']}, Product: {l['product_id']}, Status: {l['status']}")
